...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7790118521:AAHMw74Eq-imroTAh0VaDbluuZj28ORa_Lc") 
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', ' @TFIBOTS  ').split(', ')
...
➲ /set_source: ᴛᴏ sᴇᴛ ʏᴏᴜʀ ᴘʀᴇғᴇʀʀᴇᴅ sᴏᴜʀᴄᴇ ғᴏʀ ʀᴇɴᴀᴍɪɴɢ ғɪʟᴇs.
