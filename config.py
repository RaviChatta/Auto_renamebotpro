...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7955482156:AAFplRf0XjvNHJ_iVg4IbH--AHSnEAylsM0") 
    ...
    DUMP = True
    BOT_CHANNEL_NAME = os.environ.get("BOT_CHANNEL_NAME", "mymopies")
    BOT_CHANNEL_USERNAME = os.environ.get("BOT_CHANNEL_USERNAME", "Ai_Hoshinoleechbot")
    SUPPORT_CHANNEL_NAME = os.environ.get("SUPPORT_CHANNEL_NAME", "mymopies ")
    UPDATE_CHANNEL = os.environ.get("SUPPORT_CHANNEL_USERNAME", "mymopies ")
    SUPPORT_CHANNEL_USERNAME = os.environ.get("SUPPORT_CHANNEL_USERNAME", "mymopies ")
    SUPPORT_GROUP = os.environ.get("SUPPORT_CHANNEL_USERNAME", "mymopies ")
